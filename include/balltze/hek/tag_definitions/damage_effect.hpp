...
namespace Balltze::HEK::TagDefinitions { 
	...
	enum DamageEffectScreenFlashPriority : std::uint16_t {
		DAMAGE_EFFECT_SCREEN_FLASH_PRIORITY_LOW = 0,
		DAMAGE_EFFECT_SCREEN_FLASH_PRIORITY_MEDIUM,
		DAMAGE_EFFECT_SCREEN_FLASH_PRIORITY_HIGH,
	};

	enum DamageEffectSideEffect : std::uint16_t {
		DAMAGE_EFFECT_SIDE_EFFECT_NONE = 0,
		DAMAGE_EFFECT_SIDE_EFFECT_HARMLESS,
		DAMAGE_EFFECT_SIDE_EFFECT_LETHAL_TO_THE_UNSUSPECTING,
		DAMAGE_EFFECT_SIDE_EFFECT_EMP,
	};

	enum DamageEffectCategory : std::uint16_t {
		DAMAGE_EFFECT_CATEGORY_NONE = 0,
