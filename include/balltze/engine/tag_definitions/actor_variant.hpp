...
namespace Balltze::Engine::TagDefinitions { 
	enum ActorVariantMovementType : std::uint16_t {
		ACTOR_VARIANT_MOVEMENT_TYPE_ALWAYS_RUN = 0,
		ACTOR_VARIANT_MOVEMENT_TYPE_ALWAYS_CROUCH,
		ACTOR_VARIANT_MOVEMENT_TYPE_SWITCH_TYPES,
	};

	enum ActorVariantSpecialFireMode : std::uint16_t {
		ACTOR_VARIANT_SPECIAL_FIRE_MODE_NONE = 0,
		ACTOR_VARIANT_SPECIAL_FIRE_MODE_OVERCHARGE,
		ACTOR_VARIANT_SPECIAL_FIRE_MODE_SECONDARY_TRIGGER,
	};

	enum ActorVariantSpecialFireSituation : std::uint16_t {
		ACTOR_VARIANT_SPECIAL_FIRE_SITUATION_NEVER = 0,
	...
	enum ActorVariantTrajectoryType : std::uint16_t {
		ACTOR_VARIANT_TRAJECTORY_TYPE_TOSS = 0,
		ACTOR_VARIANT_TRAJECTORY_TYPE_LOB,
		ACTOR_VARIANT_TRAJECTORY_TYPE_BOUNCE,
	};

	enum ActorVariantGrenadeStimulus : std::uint16_t {
		ACTOR_VARIANT_GRENADE_STIMULUS_NEVER = 0,
